...
<head>
    ...
    <title>SB Admin 2 - Data Pendaftaran</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="datapendaftaran.html">Data Pendaftaran</a>
                        <a class="collapse-item" href="datapengajar.html">Data Pengajar</a>
                    </div>
                </div>
            </li>
